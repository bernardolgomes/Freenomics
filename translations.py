...
T_DASHBOARD = {
    "🇵🇹 Português": {
        ...
        "aviso": "⚠️ Esta análise é gerada automaticamente a partir de dados históricos e serve apenas para fins informativos/educativos, e não constitui aconselhamento financeiro.",
        ...
        "insight_volatil": lambda t, v: f"Em termos de risco, **{t}** foi o ativo mais instável, com uma volatilidade anualizada de {v}%, o que significa oscilações de preço mais acentuadas ao longo do tempo.",
    ...
    "🇬🇧 English": {
        ...
        "aviso": "⚠️ This analysis is generated automatically from historical data and is for informational/educational purposes only, and it does not constitute financial advice.",
    ...
    "🇩🇪 Deutsch": {
        ...
        "aviso": "⚠️ Diese Analyse wird automatisch aus historischen Daten generiert und stellt keine Finanzberatung dar.",
        ...
        "pdf_aviso": "Dieser Bericht wird automatisch generiert und stellt keine Finanzberatung dar.",
        ...
        "insight_drawdown": lambda t, d: f"**{t}** erlitt einen maximalen Drawdown von {d}%, zu berücksichtigen bei der Risikotoleranz.",
    ...
    "🇪🇸 Español": {
        ...
        "aviso": "⚠️ Este análisis se genera automáticamente a partir de datos históricos y no constituye asesoramiento financiero.",
        ...
        "pdf_aviso": "Este informe se genera automáticamente a partir de datos históricos y no constituye asesoramiento financiero.",
...
T_SIMULADOR = {
    ...
    "🇬🇧 English": {
        ...
        "insight": lambda cm, anos, r, ti, vf, g, inf, vr: f"By investing **€{cm:.0f}/month** for **{anos} years** at **{r}%/year**, you turn a total investment of **€{ti:,.0f}** into **€{vf:,.0f}**, and compound interest generates an extra **€{g:,.0f}**. Adjusted for {inf}% inflation, real purchasing power would be **€{vr:,.0f}**.",
    ...
    "🇫🇷 Français": {
        ...
        "insight": lambda cm, anos, r, ti, vf, g, inf, vr: f"En investissant **€{cm:.0f}/mois** pendant **{anos} ans** à **{r}%/an**, vous transformez **€{ti:,.0f}** investis en **€{vf:,.0f}**, et les intérêts composés génèrent **€{g:,.0f}** supplémentaires. Ajusté à {inf}% d'inflation, la valeur réelle serait de **€{vr:,.0f}**.",
    ...
    "🇩🇪 Deutsch": {
        ...
        "insight": lambda cm, anos, r, ti, vf, g, inf, vr: f"Durch monatliche Einzahlungen von **€{cm:.0f}** über **{anos} Jahre** bei **{r}%/Jahr** werden aus **€{ti:,.0f}** investiertem Kapital **€{vf:,.0f}**, und der Zinseszins generiert zusätzliche **€{g:,.0f}**. Bei {inf}% Inflation beträgt die reale Kaufkraft **€{vr:,.0f}**.",
    ...
    "🇪🇸 Español": {
        ...
        "insight": lambda cm, anos, r, ti, vf, g, inf, vr: f"Al invertir **€{cm:.0f}/mes** durante **{anos} años** con una rentabilidad de **{r}%/año**, conviertes **€{ti:,.0f}** invertidos en **€{vf:,.0f}**, y el interés compuesto genera **€{g:,.0f}** adicionales. Ajustando a {inf}% de inflación, el poder adquisitivo real sería de **€{vr:,.0f}**.",
