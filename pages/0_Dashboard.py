...
from translations import T_DASHBOARD, CSS, PLOT_COLORS, FIX_DROPDOWNS_JS
...
TEXTOS = {
    ...
    "🇬🇧 English": {
        ...
        "caption_benchmark": "📊 **S&P 500 (benchmark):** the dashed line represents the S&P 500, showing if your portfolio beats the market.",
